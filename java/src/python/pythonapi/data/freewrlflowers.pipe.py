            ...
            .setProtoBody(X3Dpackage.ProtoBody()
              .addChildren(X3Dpackage.Group()
                .addChildren(X3Dpackage.ProtoInstance().setName("FlowerProto")
                  .addFieldValue(X3Dpackage.fieldValue().setName("vertex").setValue("\"../shaders/freewrl_flowers_chromatic.vs\""))
                  .addFieldValue(X3Dpackage.fieldValue().setName("fragment").setValue("\"../shaders/freewrl.fs\""))))))
