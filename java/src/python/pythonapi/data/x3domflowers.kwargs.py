...
X3D0 = X3D(profile="Immersive", version="3.3",    head1 = head(    meta2 = meta(name="title", content="sphereflowers.x3d"), 
   ...
   Scene7 = Scene(    NavigationInfo8 = NavigationInfo(type=["EXAMINE","ANY"]), 
    ...
    Group10 = Group(     ExternProtoDeclare11 = ExternProtoDeclare(name="FlowerProto", url=["../data/flowerproto.json#FlowerProto"],       field12 = field(accessType="inputOutput", name="vertex", type="MFString"), 
      field13 = field(accessType="inputOutput", name="fragment", type="MFString")), 
     ProtoDeclare14 = ProtoDeclare(name="flower",       ProtoBody15 = ProtoBody(       Group16 = Group(        ProtoInstance17 = ProtoInstance(name="FlowerProto",          fieldValue18 = fieldValue(name="vertex", value="\"../shaders/x3dom_flowers_chromatic.vs\""), 
