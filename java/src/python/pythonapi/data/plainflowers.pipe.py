            ...
            .setProtoBody(X3Dpackage.ProtoBody()
              .addChildren(X3Dpackage.Group()
                .addChildren(X3Dpackage.ProtoInstance().setName("FlowerProto")
                  .addFieldValue(X3Dpackage.fieldValue().setName("vertex").setValue("\"../shaders/cobweb_flowers_plain.vs\""))
                  .addFieldValue(X3Dpackage.fieldValue().setName("fragment").setValue("\"../shaders/plain.fs\""))))))
