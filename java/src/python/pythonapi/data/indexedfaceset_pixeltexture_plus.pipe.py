...
X3D0 = (X3Dpackage.X3D().setProfile("Interchange").setVersion("3.0")
      .setHead(X3Dpackage.head()
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus.x3d").setName("title"))
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus-front.jpg").setName("Image"))
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus-rear.jpg").setName("Image"))
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus-top.jpg").setName("Image"))
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus-bottom.jpg").setName("Image"))
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus-left.jpg").setName("Image"))
        .addMeta(X3Dpackage.meta().setContent("indexedfaceset_pixeltexture_plus-right.jpg").setName("Image"))
        ...
        .addMeta(X3Dpackage.meta().setContent("Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube.").setName("description"))
        .addMeta(X3Dpackage.meta().setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d").setName("identifier"))
      ...
      .setScene(X3Dpackage.Scene()
        ...
        .addChildren(X3Dpackage.Shape()
          ...
          .setGeometry(X3Dpackage.IndexedFaceSet(setColorPerVertex = False, setCoordIndex = [0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1], setCreaseAngle = 0.5, setTexCoordIndex = [0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1])
            ...
            .setTexCoord(X3Dpackage.TextureCoordinate().setPoint([-1,2,-1,-1,2,2,2,-1]))))))
