...
"            ''', )))), 
    ...
    ProtoInstance62 = ProtoInstance(DEF="G3", name="point"), 
    ProtoInstance63 = ProtoInstance(DEF="G4", name="point"), 
    ProtoInstance64 = ProtoInstance(name="x3dconnector", DEF="connector1",      fieldValue65 = fieldValue(name="startnode",       ProtoInstance66 = ProtoInstance(USE="G1")), 
     fieldValue67 = fieldValue(name="endnode",       ProtoInstance68 = ProtoInstance(USE="G2")), 
     fieldValue69 = fieldValue(name="set_startpoint"), 
     fieldValue70 = fieldValue(name="set_endpoint")), 
    ProtoInstance71 = ProtoInstance(name="x3dconnector", DEF="connector2",      fieldValue72 = fieldValue(name="startnode",       ProtoInstance73 = ProtoInstance(USE="G1")), 
     fieldValue74 = fieldValue(name="endnode",       ProtoInstance75 = ProtoInstance(USE="G3")), 
     fieldValue76 = fieldValue(name="set_startpoint"), 
     fieldValue77 = fieldValue(name="set_endpoint")), 
    ProtoInstance78 = ProtoInstance(name="x3dconnector", DEF="connector3",      fieldValue79 = fieldValue(name="startnode",       ProtoInstance80 = ProtoInstance(USE="G1")), 
     fieldValue81 = fieldValue(name="endnode",       ProtoInstance82 = ProtoInstance(USE="G4")), 
     fieldValue83 = fieldValue(name="set_startpoint"), 
     fieldValue84 = fieldValue(name="set_endpoint")), 
    ROUTE85 = ROUTE(fromNode="G1", fromField="translation", toNode="connector1", toField="set_startpoint"), 
    ROUTE86 = ROUTE(fromNode="G2", fromField="translation", toNode="connector1", toField="set_endpoint"), 
    ROUTE87 = ROUTE(fromNode="G1", fromField="translation", toNode="connector2", toField="set_startpoint"), 
    ROUTE88 = ROUTE(fromNode="G3", fromField="translation", toNode="connector2", toField="set_endpoint"), 
    ROUTE89 = ROUTE(fromNode="G1", fromField="translation", toNode="connector3", toField="set_startpoint"), 
    ROUTE90 = ROUTE(fromNode="G4", fromField="translation", toNode="connector3", toField="set_endpoint")))
