...
public class HelloWorldProgramOutput_Node
{
	/** Default constructor to create this object. */
	public HelloWorldProgramOutput_Node ()
	{
	  initialize();
	}
	...
	{
  x3dModel = new X3DObject().setProfile(X3DObject.PROFILE_IMMERSIVE).setVersion(X3DObject.VERSION_4.0)
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_MODIFIED   ).setContent("25 May 2020"))
...
"}" + "\n")
    ...
    {
        X3DObject thisExampleX3dObject = new HelloWorldProgramOutput_Node().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"HelloWorldProgramOutput_Node\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dObject.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"HelloWorldProgramOutput_Node\" self-validation test results: ");
