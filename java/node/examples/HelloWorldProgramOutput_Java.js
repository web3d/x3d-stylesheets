...
var ProtoInstance6 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setContent("HelloWorldProgramOutput.x3d").setName("title"))
        .addMeta(new autoclass.meta().setContent("continued development and testing in progress").setName("info"))
        .addMeta(new autoclass.meta().setContent("Example HelloWorldProgram creates an X3D model using the X3D Java Scene Access Interface Library (X3DJSAIL)").setName("description"))
        .addMeta(new autoclass.meta().setContent("https://www.web3d.org/specifications/java/X3DJSAIL.html").setName("reference"))
        .addMeta(new autoclass.meta().setContent("HelloWorldProgramOutput.java").setName("generator"))
        .addMeta(new autoclass.meta().setContent("6 September 2016").setName("created"))
        .addMeta(new autoclass.meta().setContent("4 April 2020").setName("modified"))
        .addMeta(new autoclass.meta().setContent("X3D Java Scene Access Interface Library (X3DJSAIL)").setName("generator"))
        .addMeta(new autoclass.meta().setContent("https://www.web3d.org/specifications/java/examples/HelloWorldProgram.java").setName("generator"))
        .addMeta(new autoclass.meta().setContent("Netbeans http://www.netbeans.org").setName("generator"))
        .addMeta(new autoclass.meta().setContent("Don Brutzman").setName("creator"))
        .addMeta(new autoclass.meta().setContent("https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/java/examples/HelloWorldProgramOutput.x3d").setName("reference"))
        .addMeta(new autoclass.meta().setContent("Console output, ClassicVRML encoding, VRML97 encoding and pretty-print documentation:").setName("reference"))
        .addMeta(new autoclass.meta().setContent("HelloWorldProgramOutput.txt").setName("reference"))
        .addMeta(new autoclass.meta().setContent("HelloWorldProgramOutput.x3dv").setName("reference"))
        .addMeta(new autoclass.meta().setContent("HelloWorldProgramOutput.wrl").setName("reference"))
        .addMeta(new autoclass.meta().setContent("HelloWorldProgramOutput.html").setName("reference"))
        .addMeta(new autoclass.meta().setContent("https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d").setName("reference"))
        .addMeta(new autoclass.meta().setContent("https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d").setName("identifier"))
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.NavigationInfo().setType(java.newArray("java.lang.String", ["EXAMINE","FLY","ANY"])).setAvatarSize(java.newArray("float", [java.newFloat(0.25), java.newFloat(1.6), java.newFloat(0.75)])).setTransitionType(java.newArray("java.lang.String", ["LINEAR"])))
        ...
        .addChild(new autoclass.WorldInfo().setUSE("WorldInfoDEF"))
        .addMetadata(new autoclass.MetadataString().setDEF("scene.addChildMetadata").setName("test").setValue(java.newArray("java.lang.String", ["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"])))
        .addLayerSet(new autoclass.LayerSet().setDEF("scene.addChildLayerSetTest").setOrder(java.newArray("int", [0])))
        ...
        .addChild(new autoclass.TimeSensor().setDEF("OrbitClock").setCycleInterval(8.0).setLoop(true))
        ...
        .addChild(new autoclass.Transform().setDEF("TextTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(-1.5), java.newFloat(0)]))
          .addChild(new autoclass.Shape()
            ...
            .setGeometry(new autoclass.Text().setString(java.newArray("java.lang.String", ["X3D Java","SAI Library","X3DJSAIL"]))
              ...
              .setFontStyle(new autoclass.FontStyle().setFamily(java.newArray("java.lang.String", ["SERIF"])).setJustify(java.newArray("java.lang.String", ["MIDDLE","MIDDLE"])))))
        ...
        .addChild(new autoclass.TimeSensor().setDEF("SpinClock").setCycleInterval(5.0).setLoop(true))
...
""))
          ...
          .addChild(new autoclass.TimeSensor().setDEF("ColorClock").setCycleInterval(60.0).setLoop(true))
        ...
        .addChild(new autoclass.Shape().setDEF("TestShape2")
          .setAppearance(new autoclass.Appearance().setDEF("TestAppearance2")
            ...
            .setMaterial(ProtoInstance1 = new autoclass.ProtoInstance().setDEF("ArtDeco02MaterialDEF").setName("ArtDeco02Material")
        ...
        .addChild(new autoclass.ProtoDeclare().setName("MaterialModulator").setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          .setProtoInterface(new autoclass.ProtoInterface()
            ...
            .addField(new autoclass.field().setType(autoclass.field.TYPE_SFFLOAT).setName("transparency").setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setValue("0.0"))
            .addField(new autoclass.field().setType(autoclass.field.TYPE_SFFLOAT).setName("shininess").setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setValue("0.0"))
            .addField(new autoclass.field().setType(autoclass.field.TYPE_SFFLOAT).setName("ambientIntensity").setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setValue("0.0")))
          .setProtoBody(new autoclass.ProtoBody()
...
""))))
        ...
        .addChild(new autoclass.Group().setDEF("DeclarativeGroupExample")
          .addChild(new autoclass.Shape()
            .setMetadata(new autoclass.MetadataString().setDEF("FindableMetadataStringTest").setName("findThisNameValue").setValue(java.newArray("java.lang.String", ["test case"])))
            .setAppearance(new autoclass.Appearance().setDEF("DeclarativeAppearanceExample")
              ...
              .setMaterial(ProtoInstance3 = new autoclass.ProtoInstance().setDEF("MyMaterialModulator").setName("MaterialModulator")))
        ...
        .addChild(new autoclass.Shape().setDEF("ExtrusionShape")
          ...
          .setAppearance(new autoclass.Appearance().setDEF("TransparentAppearance")
            .setMaterial(new autoclass.Material().setTransparency(java.newFloat(1.0))))
        ...
        .addChild(new autoclass.Group()
          ...
          .addChild(ProtoInstance4 = new autoclass.ProtoInstance().setDEF("Proto1").setName("NewWorldInfo"))
          .addChild(new autoclass.Group().setDEF("Node2")
            .addComments(new autoclass.CommentsBlock(" intentionally empty ")))
          .addChild(ProtoInstance5 = new autoclass.ProtoInstance().setDEF("Proto3").setName("NewWorldInfo"))
        ...
        .addChild(new autoclass.Shape()
          .setAppearance(new autoclass.Appearance()
            ...
            .addShaders(new autoclass.ProgramShader().setDEF("TestShader1")
              .addPrograms(new autoclass.ShaderProgram().setDEF("TestShader2")))
            .addShaders(ProtoInstance6 = new autoclass.ProtoInstance().setDEF("TestShader3").setName("ShaderProto"))
            .addShaders(new autoclass.ComposedShader().setDEF("TestShader4")
              .addParts(new autoclass.ShaderPart().setDEF("TestShader5")))))
        .addChild(new autoclass.Transform().setDEF("SpecialtyNodes")
          ...
          .addChild(new autoclass.EspduTransform().setGeoSystem(java.newArray("java.lang.String", ["GD","WE"])))
          .addChild(new autoclass.ReceiverPdu().setGeoSystem(java.newArray("java.lang.String", ["GD","WE"])))
          .addChild(new autoclass.SignalPdu().setGeoSystem(java.newArray("java.lang.String", ["GD","WE"])))
          .addChild(new autoclass.TransmitterPdu().setGeoSystem(java.newArray("java.lang.String", ["GD","WE"])))
...
ProtoInstance4
    ...
    X3D0.toFileX3D("examples/HelloWorldProgramOutput_Java.new.x3d");
